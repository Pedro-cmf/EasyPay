...
import {
  ...
  FormInput, SubmitButton, CheckboxLabel, Labels, ParagrafoPrincipal,
  ErrorMessage, SuccessModal, SuccessContent, SuccessButton
} from './styles';
...
function OpenAccountModal({ isOpen, onRequestClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const newUser = {
      ...
      accountNumber,
      balance: 0,
      key: Math.random().toString(36).substring(2, 15) // Gera chave aleatória
    };
